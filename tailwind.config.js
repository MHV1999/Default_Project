...
export default {
  ...
  theme: {
    extend: {
      fontFamily: {
        'iran-sans': ['IRANSansXFaNum', 'Tahoma', 'Arial', 'sans-serif'],
        'sans': ['IRANSansXFaNum', 'ui-sans-serif', 'system-ui', 'sans-serif'],
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      colors: {
        // shadcn/ui colors
        background: "hsl(var(--peach-orange-500))",
        foreground: "hsl(var(--error-500))",
